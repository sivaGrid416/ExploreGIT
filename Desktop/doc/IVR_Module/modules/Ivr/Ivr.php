...
class Ivr extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_ivr';
	var $table_index= 'ivrid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_ivrcf', 'ivrid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_ivr', 'vtiger_ivrcf');
	...
	var $list_fields = Array (
		...
		'<entityfieldlabel>' => Array('ivr', '<entitycolumn>'),
