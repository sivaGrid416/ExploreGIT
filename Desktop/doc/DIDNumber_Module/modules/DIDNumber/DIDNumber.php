...
class DIDNumber extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_didnumber';
	var $table_index= 'didnumberid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_didnumbercf', 'didnumberid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_didnumber', 'vtiger_didnumbercf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_didnumber' => 'didnumberid',
		'vtiger_didnumbercf'=>'didnumberid');
	...
	var $list_fields = Array (
		...
		'<entityfieldlabel>' => Array('didnumber', '<entitycolumn>'),
