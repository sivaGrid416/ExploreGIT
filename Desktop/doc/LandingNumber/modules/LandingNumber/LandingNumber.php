...
class LandingNumber extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_landingnumber';
	var $table_index= 'landingnumberid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_landingnumbercf', 'landingnumberid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_landingnumber', 'vtiger_landingnumbercf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_landingnumber' => 'landingnumberid',
		'vtiger_landingnumbercf'=>'landingnumberid');
	...
	var $list_fields = Array (
		...
		'<entityfieldlabel>' => Array('landingnumber', '<entitycolumn>'),
