		...
		<form name='list' id='listedit' action='' onsubmit="return false;">
			<table id="listview-table" class="table {if $LISTVIEW_ENTRIES_COUNT eq '0'}listview-table-norecords {/if} listview-table ">
				...
				<tbody class="overflow-y">
                    ...
                    <a  href="http://192.168.10.94/crmpbx/crm_c2c.php?phoneno={$LISTVIEW_ENTRY->get($LISTVIEW_HEADERNAME)}&exten={$CURRENT_USER_MODEL->get('phone_crm_extension')}&type=list">{$LISTVIEW_ENTRY->get($LISTVIEW_HEADERNAME)}</a>
