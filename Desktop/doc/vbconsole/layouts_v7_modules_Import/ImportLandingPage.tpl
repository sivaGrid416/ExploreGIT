		...
		<div class='modal-body' style="margin-bottom:100%" id ="landingPageDiv">
			...
			<div class="landingPage container-fluid importServiceSelectionContainer">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id = "csvImport" >
					<div class="menu-item app-item app-SALES" style="background-color:#078227 !important">
						<span class="fa fa-file-text"></span>
						<div>
						<!-- <p style="font-size: 18px; margin-bottom: -10px;">Click here to Import</p> -->
					...
					<p>While Importing data, your file should have these columns:</p>
					<ol>
						<li>Mobile phone - 10 digit without space</li>
						<li>Filter - Name of your list</li>
					</ol>
					</div>
				</div>
